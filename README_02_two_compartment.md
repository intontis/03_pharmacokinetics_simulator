...
**Blood Compartment ODE:** $\boldsymbol{\frac{dC_1}{dt} = -k_{12} \cdot C_1 + k_{21} \cdot C_2 - k_e \cdot C_1}$

**Tissue Compartment ODE:** $\boldsymbol{\frac{dC_2}{dt} = k_{12} \cdot C_1 - k_{21} \cdot C_2}$
...
the transfer rates k12/k21 play the role of coupling constants.
